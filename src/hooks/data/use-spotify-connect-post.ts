...
const PATH = '/spotify/connect' as const;

type Init = MaybeOptionalInit<paths["/spotify/connect"], "post">
type Response = Required<FetchResponse<paths["/spotify/connect"]["post"], Init, "application/json">>
type Options = Omit<UseMutationOptions<Response["data"], Response["error"], Init>, "mutationKey" | "mutationFn">;

export function useSpotifyConnectPost(options?: Options) {
  ...
  return useMutation(
    ...
    PATH,
    {
      ...
      onSuccess: async (data, variables, context) => {
        ...
        successMessage({
          description: 'Spotify account connected'
        })
