...
import DisplayBoardWaitingScreen from "@/components/pages/DisplayBoardPage/DisplayBoardWaitingScreen.vue";
...
import DisplayBoardPageInfo from "@/components/pages/DisplayBoardPage/DisplayBoardPageInfo.vue";
