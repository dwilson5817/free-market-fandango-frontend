      ...
      <div class="grid grid-cols-12">
        <div class="col-span-10 bg-white dark:bg-gray-800 dark:border-gray-700 p-5">
          ...
          <p class="mb-1 font-normal text-gray-500 dark:text-gray-400">
            Use the QR code to the right, or visit <strong>dyln.dev/u/cIMI2y</strong> to:
          </p>

          <ul class="list-disc ml-4 font-normal text-gray-500 dark:text-gray-400">
            <li>See how to play</li>
            <li>Check your card balance and see recent transactions</li>
            <li>See live stock information from your phone</li>
          </ul>
        </div>
