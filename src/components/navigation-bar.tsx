      ...
      <div className="container w-full mx-auto px-4 lg:px-6 md:flex items-center gap-6">
        <div className="flex flex-grow my-3 md:my-0 items-center md:flex-initial">
          <Link to="/" className="flex flex-grow md:flex-initial gap-2">
            ...
            <span className="font-bold">Free Market Fandango</span>
          </Link>
          <Button
        ...
        <div
          className={`${!dropdownActive && "hidden"} block md:flex md:flex-1 md:gap-5 text-sm`}
        >
          {links.map((link) => (
            <NavLink
              key={link.name}
        ...
        <div
          className={`${!dropdownActive ? "hidden" : "flex"} mt-4 mb-3 md:my-0 md:flex flex-initial gap-1`}
        >
          <Link
            to="/admin"
